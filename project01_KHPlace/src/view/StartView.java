...
public class StartView {
    ...
    private SaveAndLoadView saveAndLoadView = new SaveAndLoadView(); // 3. 이어 하기
        ...
        while(true) {
            ...
            try {
                ...
                switch (input) {
                    ...
                    case 3: saveAndLoadView.displayLoadMenu(); break;   // 저장된 플레이 기록 불러 오기
                    case 4: Service.exit(0); return;              // 프로그램 종료
