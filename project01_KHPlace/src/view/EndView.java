...
public class EndView {
   ...
   public void dislayGameResult() {
      ...
      System.out.println("손님 수 : " + owner.getGuestNumSum());
      System.out.println("총 매출액 : " + owner.getTotalSalesSum());
      System.out.println("순 수익 (총 매출액 - 총 지출액) : " + Math.abs(owner.getTotalSalesSum() - owner.getTotalPurchasesSum()));
      displayLastEndView();
   }
